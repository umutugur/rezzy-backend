...
export const createReservationSchema = Joi.object({
  body: Joi.object({
    ...
    // partySize opsiyonel; gelse de mismatch'te hata atılmayacak
    partySize: Joi.number().min(1).optional(),
    // FE isterse selectionMode ile niyeti açıkça söyleyebilir
    selectionMode: Joi.string().valid("index", "count").optional(),
